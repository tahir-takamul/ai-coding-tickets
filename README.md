...
| [`MIT-5211`](MIT-5211/task/STATE.md) | T02–T05 + T07 DONE; T06 in flight (defaults); T08 needs operator | APISIX on silmarils-qa AKS: two-layer ansible (15a base / 15b silmarils LFI overlay) behind Cloudflare Tunnel; APISIX terminates mTLS via `X-Forwarded-Client-Cert`. |
