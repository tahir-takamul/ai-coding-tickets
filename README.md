...
| [`MIT-5211`](MIT-5211/task/STATE.md) | Authoring DONE (T01–T07); T08 awaits operator + first CI image | APISIX on silmarils-qa AKS: two-layer ansible (15a base / 15b silmarils LFI overlay) behind Cloudflare Tunnel; APISIX terminates mTLS via `X-Forwarded-Client-Cert`. |
