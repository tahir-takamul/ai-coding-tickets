...
| `MIT-5211` | Authoring DONE (T01–T07); T08 awaits operator + first CI image | APISIX on silmarils-qa AKS: two-layer ansible (15a base / 15b silmarils LFI overlay) behind Cloudflare Tunnel; APISIX terminates mTLS via `X-Forwarded-Client-Cert`. Entry point: `MIT-5211/task/STATE.md`. |
