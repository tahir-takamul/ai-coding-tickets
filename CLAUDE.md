...
| `MIT-5211` | T01 in progress (G2/G5/G7 closed; G1/G3/G4/G6 operator-pending; G8 partial) | APISIX on silmarils-qa AKS: two-layer ansible (15a base / 15b silmarils LFI overlay) behind Cloudflare Tunnel; APISIX terminates mTLS via `X-Forwarded-Client-Cert`. Entry point: `MIT-5211/task/STATE.md`. |
